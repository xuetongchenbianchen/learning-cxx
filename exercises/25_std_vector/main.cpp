...
int main(int argc, char **argv) {
    {
        ...
        ASSERT(vec.size() * sizeof(int) ==20, "Fill in the correct value.");
        int ans[]{1, 2, 3, 4, 5};
    ...
    }
    {
        ...
        {
            ASSERT(vec.size() ==5, "Fill in the correct value.");
            ASSERT(vec.size() * sizeof(double) ==40, "Fill in the correct value.");
        ...
        }
        {
            ...
            ASSERT(vec.size() * sizeof(double) == 48, "Fill in the correct value.");
            vec.pop_back();
            ASSERT(vec.size() ==5, "Fill in the correct value.");
            ASSERT(vec.size() * sizeof(double) == 40, "Fill in the correct value.");
        }
    ...
    }
    {
        ...
        ASSERT(vec.size() * sizeof(char) == 48, "Fill in the correct value.");
        {
