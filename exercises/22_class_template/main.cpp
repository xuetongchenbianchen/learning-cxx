            ...
            for(unsigned int j = 0;j<shape[1];j++)
                for(unsigned int k = 0;k<shape[2];k++)
                    for(unsigned int l = 0;l<shape[3];l++){
                        ...
                        unsigned int others_index = (i % others.shape[0]) * others_stride[0] +
                                                    (j % others.shape[1]) * others_stride[1] +
                                                    (k % others.shape[2]) * others_stride[2] +
                                                    (l % others.shape[3]) * others_stride[3];
